[中文 README.md](https://github.com/westhack/webkubectl/blob/master/README.zh_CN.md)

# ![](https://raw.githubusercontent.com/westhack/webkubectl/master/gotty/resources/favicon.png) Web Kubectl - Run kubectl command in web browser

[![Downloads](https://img.shields.io/docker/pulls/westhack/webkubectl?label=downloads)](https://hub.docker.com/r/westhack/webkubectl)
[![Go Report Card](https://goreportcard.com/badge/github.com/westhack/webkubectl)](https://goreportcard.com/report/github.com/westhack/webkubectl)
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/westhack/webkubectl/build-and-push-to-dockerhub)](https://github.com/westhack/webkubectl/actions/workflows/publish-to-dockerhub.yml)
![License](https://img.shields.io/github/license/westhack/webkubectl)
![Dockerized](https://img.shields.io/badge/dockerized-yes-brightgreen)
![Version](https://img.shields.io/github/v/release/westhack/webkubectl)
![Visitors](https://page-views.glitch.me/badge?page_id=westhack.webkubectl)

![webkubectl](https://raw.githubusercontent.com/westhack/webkubectl/master/web-resources/webkubectl.gif)
...
# Architecture
Web Kubectl use [webkubectl/gotty](https://github.com/westhack/webkubectl/tree/master/gotty) to run a JavaScript based terminal on web browsers.<br>
...
```sh
$ docker run --name="webkubectl" -p 8080:8080 -d --privileged westhack/webkubectl
```
...
| GOTTY_OPTIONS | string | --port 8080 --permit-write --permit-arguments |   Gotty options, see [more](https://github.com/westhack/webkubectl/blob/master/gotty/GOTTY_USAGE.md#options) |
...
![index](https://raw.githubusercontent.com/westhack/webkubectl/master/web-resources/index.jpg)

![terminal](https://raw.githubusercontent.com/westhack/webkubectl/master/web-resources/terminal.jpg)
...
-  **Authentication**：By default all resources can be accessed without any authentication, to restrict anonymous access, you can enable the  basic authentication of gotty, see [how to](https://github.com/westhack/webkubectl/issues/19).
-  **SSL/TLS**：By default all traffic between the server and clients are NOT encrypted, we recommend you enable SSL/TLS option of gotty, see [how to](https://github.com/westhack/webkubectl/blob/master/gotty/GOTTY_USAGE.md#options). Alternatively you can deploy Web Kubectl behind a proxy and enable SSL/TLS for the proxy, please note that the proxy should support WebSocket protocol.
...
# Dependencies 
-  [webkubectl/gotty](https://github.com/westhack/webkubectl/tree/master/gotty)
...
> westhack is an open source project, a web based application enable you to deploy and manage production ready Kubernetes clusters on VMware, Openstack, virtual machines and physical machines in LAN network without internet connectivity.<br>
> [https://github.com/westhack/webkubectl](https://github.com/westhack/webkubectl)