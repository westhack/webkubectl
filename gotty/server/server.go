...
import (
	...
	"github.com/westhack/webkubectl/gotty/cache/token"
	"github.com/westhack/webkubectl/gotty/pkg/randomstring"
	"github.com/westhack/webkubectl/gotty/webtty"
	...
	"github.com/westhack/webkubectl/gotty/pkg/homedir"
)
...
func New(factory Factory, options *Options, redisOptions *RedisOptions) (*Server, error) {
	...
	if redisOptions.UseRedisTokenCache == "true" {
		...
		cache = token.NewRedisCache(client, "westhack-webkubectl-")
	} else {
